<?php 
    ...
    { 
        ...
        { 
            $response["success"] = 0;
			$response["message"] = "Invalid Email Adress";
            die(json_encode($response)); 
        } 
        ...
        { 
            $response["success"] = 0;
			$response["message"] = "The Username You Entered Is Already In Use!";
            die(json_encode($response)); 
        } 
        ...
        { 
            ...
            $response["success"] = 0;
			$response["message"] = "The Email Adress You Entered Is Already In Use!";
            die(json_encode($response)); 
        } 
